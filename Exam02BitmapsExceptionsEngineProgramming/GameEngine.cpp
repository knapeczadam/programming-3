...
tstring BitmapUnsupportedFormatException::GetMessage() const
{
	tstringstream buffer;
	buffer << _T("Image format not supported: ");
	buffer << m_Message;
	return buffer.str();
}
...
tstring BitmapMissingFileException::GetMessage() const
{
	tstringstream buffer;
	buffer << _T("File not found: ");
	buffer << m_Message;
	return buffer.str();
}

...
class BitmapUnsupportedFormatException : public AbstractBitmapException
{
public:
	BitmapUnsupportedFormatException(const tstring& message);
	tstring GetMessage() const override;
};

class BitmapMissingFileException : public AbstractBitmapException
{
public:

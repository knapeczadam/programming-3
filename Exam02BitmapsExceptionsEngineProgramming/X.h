...
private:
	bool IsValidBmpFileName(const tstring& fileName) const;
	bool IsValidTgaFileName(const tstring& fileName) const;
	bool IsValidPngFileName(const tstring& fileName) const;
	bool IsValidImageFileName(const tstring& fileName) const;
